...
<meta name="description" content="<?php echo ($f_metaDes); ?>"/>
    ...
    <?php else: ?>
        <link href="<?php echo RES;?>/css/style-{kmdx:$usertplid}.css?id=103" rel="stylesheet" type="text/css" /><?php endif; ?>
...
<div class="welcome">欢迎使用<?php echo ($f_siteName); ?>多用户微信营销服务平台!</div>
    <div class="memberinfo"  id="destoon_member">	
		<?php if($_SESSION[uid]==false): ?>你好&nbsp;&nbsp;<span class="f_red">游客</span>&nbsp;&nbsp;
			...
			<?php else: ?>
			你好,<a href="/index.php?g=User&m=Index&a=index" hidefocus="true"  ><span style="color:red"><?php echo (session('uname')); ?></span></a>（uid:<?php echo (session('uid')); ?>）
    ...
    <div class="logofix" id="navFixed" style="display:none;">
        ...
        <div class="toplink">
            ...
            <h1><a href="/" title="多用户微信营销服务平台"><img src="<?php echo ($f_logo); ?>" width="130px" /></a></h1>
            <div class="navr" id="nav">
            <ul id="topMenu">           
			 <li <?php if((ACTION_NAME == 'index') and (GROUP_NAME == 'Home')): ?>class="menuon"<?php endif; ?> ><a href="/" >首页</a></li>
                <li <?php if((ACTION_NAME) == "fc"): ?>class="menuon"<?php endif; ?>><a href="<?php echo U('Home/Index/fc');?>">功能介绍</a></li>
