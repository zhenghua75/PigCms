...
abstract class Action {
   ...
   /**
     ...
     * @return void
     */
    protected function error($message,$jumpUrl='',$ajax=false,$waits=3) {
        $this->dispatchJump($message,0,$jumpUrl,$ajax,$waits);
    }
     ...
     * @return void
     */
    protected function success($message,$jumpUrl='',$ajax=false,$waits=1) {
        $this->dispatchJump($message,1,$jumpUrl,$ajax,$waits);
    }
     ...
     * @return void
     */
    private function dispatchJump($message,$status=1,$jumpUrl='',$ajax=false,$waits=3) {
