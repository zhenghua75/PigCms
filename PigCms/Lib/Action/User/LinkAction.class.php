...
class LinkAction extends UserAction{
	...
	public function _initialize() {
		...
		if(C('server_topdomain')=='kmdx.cn'){
			//demo settings
			$this->arr = array('game','Invite','Red_packet', 'Seckill','Autumns','Popularity','Helping','Jiugong','MicroBroker','Crowdfunding',"Unitary","DishOut","LivingCircle","Test","Bargain","Service","Hongbao","Micrstore","SeniorScene","ServiceChat","Voteimg","AddressBook","RentCar");
