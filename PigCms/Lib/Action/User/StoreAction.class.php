...
//	        }
	...
	public function productSave() {
        ...
        $endtime = isset($_POST['endtime']) ? strtotime(htmlspecialchars($_POST['endtime'])) : '';
		...
		$data = array('token' => $token, 'gid' => $gid, 'status' => $status, 'cid' => $this->_cid, 'num' => $num, 'fakemembercount' => $fakemembercount, 
			'sort' => $sort, 'catid' => $catid, 'name' => $name, 'price' => $price, 'mailprice' => $mailprice, 'vprice' => $vprice, 'oprice' => $oprice, 
			'intro' => $intro, 'logourl' => $pic, 'keyword' => $keyword, 'time' => time(), 'allow_distribution' => $allow_distribution, 
			'commission_type' => $commission_type, 'commission' => $commission,'endtime' => $endtime);
