...
*/
		...
		//
		$wecha=M('Wxuser')->field('wxname,wxid,headerpic,weixin,appname,appicon,apploadingSmall,apploadingMedium,apploadingLarge,apploadingXLarge,apploadingDefault,apploadingDefault2x,apploadingDefault568h2x,apploadingDefault667h,apploadingDefault736h')->where(array('token'=>session('token'),'uid'=>session('uid')))->find();
